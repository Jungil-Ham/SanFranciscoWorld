...
[R, clusteredLinesIdx,R_SLP, maxVoteSumIdx, ransacIterCnt] = detectOrthogonalLine2RANSAC_ODEP(R_SLP_old, planeNormalVector, alpha, pNVIdx, lines, Kinv, cam, optsLPIC,imageCurForLine,imgIdx);
%---------------------------------------------------%
h1 = figure(9);
nexttile
plot_planes_image(R, surfaceNormalVector, surfacePixelPoint, imageCur, optsLPIC)
